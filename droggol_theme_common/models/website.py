...
class Website(models.Model):
    ...
    def get_theme_prime_bottom_bar_action_buttons(self):
        ...
        return {'tp_home': {'name': _("Inicio"), 'url': '/', 'icon': 'fa fa-home'}, 'tp_search': {'name': _("Buscar"), 'icon': 'dri dri-search', 'action_class': 'tp-search-sidebar-action'}, 'tp_wishlist': {'name': _("Wishlist"), 'icon': 'dri dri-wishlist', 'url': '/shop/wishlist'}, 'tp_offer': {'name': _("Offertas"), 'url': '/offers', 'icon': 'dri dri-bolt'}, 'tp_brands': {'name': _("Marcas"), 'icon': 'dri dri-tag-l ', 'url': '/shop/all-brands'}, 'tp_category': {'name': _("Category"), 'icon': 'dri dri-category', 'action_class': 'tp-category-action'}, 'tp_orders': {'name': _("Ordenes"), 'icon': 'fa fa-file-text-o', 'url': '/my/orders'}, 'tp_cart': {'name': _("Cesta"), 'icon': 'dri dri-cart', 'url': '/shop/cart'}, 'tp_lang_selector': {'name': _("Selector de Idioma")}}
